...
double AggroBot::evaluateHandStrength(const Gamestate& gameState) {
...
// add later once the bots get more complicated -- ML bot will definitely want to take into account
// double AggroBot::getPreFlopStrength() {
//     auto cards = getMyHand().getCards();
